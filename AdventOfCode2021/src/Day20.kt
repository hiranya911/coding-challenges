...
class Image(
    private val pixels: Map<Pair<Int, Int>, String>,
    private val enhancer: List<String>,
    private val defaultPixel: String = "0",
    ...
    fun activePixels(): Int = pixels.values.sumOf { it.toInt() }
    ...
    private fun enhanceHorizontalEdges(result: MutableMap<Pair<Int, Int>, String>) {
    ...
    private fun enhanceVerticalEdges(result: MutableMap<Pair<Int, Int>, String>) {
        for (y in minY..maxY) {
    ...
    private fun nextDefaultPixel(): String =
        (1..9).joinToString("") { defaultPixel }.toInt(2).let { enhancer[it] }

    private fun getEnhancedPixel(p: Pair<Int, Int>): String =
        neighborhood.joinToString("") { pixels[p.plus(it)] ?: defaultPixel }.toInt(2)
            .let { enhancer[it] }
